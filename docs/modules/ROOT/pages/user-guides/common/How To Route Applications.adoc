...
Employ MicroProfile Config properties to specify the endpoints, allowing different server URLs during development and production. With this setup, xref:user-guides/common/application/Configure Application.adoc[app deployment configuration] on {productName} can override these properties.
